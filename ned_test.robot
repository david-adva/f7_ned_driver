...
Crs-Create-EOU
    ...
    @{crosstype_failed_list}    Create List    2WAY_PASS    1WAY_PASS    #    : FOR    ${crosstype}
    ...    # IN    @{crosstype_list}    #    Create Entity    ${crs_add}    PATH-NODE=6
    ...    # EOU=${True}    ALIAS=my_crs    # CROSS_TYPE=${crosstype}    TYPE__FACILITY=OTU3    PATH-NODE__REVERSE=4
    #    Create Entity    ${crs_add}    PATH-NODE=6    EOU=${True}    ALIAS=my_crs    CROSS_TYPE=ADD
    ...    # TYPE__FACILITY=OTU3    PATH-NODE__REVERSE=4
    Create Entity    ${crs_drop}    PATH-NODE=2    EOU=${True}    ALIAS=my_crs    CROSS_TYPE=DROP    TYPE__FACILITY=OTU3
